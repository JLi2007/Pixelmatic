...
public void Revert_image(GButton source, GEvent event) { //_CODE_:button1:863431:
  revertToOriginal();
...
public void createGUI(){
  ...
  revert_btn = new GButton(window1, 0, 325, 80, 30);
  revert_btn.setText("Revert");
  revert_btn.addEventHandler(this, "Revert_image");
