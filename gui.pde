...
public void Change_Saturation(GKnob source, GEvent event) { //_CODE_:Huee:883956:
...
public void createGUI(){
  ...
  Saturation = new GKnob(window1, 250, 250, 60, 60, 0.8);
  Saturation.setTurnRange(110, 70);
  Saturation.setTurnMode(GKnob.CTRL_HORIZONTAL);
  Saturation.setSensitivity(1);
  Saturation.setShowArcOnly(false);
  Saturation.setOverArcOnly(false);
  Saturation.setIncludeOverBezel(false);
  Saturation.setShowTrack(true);
  Saturation.setLimits(0.0, -180.0, 180.0);
  Saturation.setShowTicks(true);
  Saturation.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
